...
const SeatMapKing: React.FC<SeatMap2Props> = ({
  seats = [],
  onSeatSelect,
  selectedSeats = [],
  TYPE_COLORS = [],
  ...
  return (
    <>
      ...
      <div
        ...
        ref={containerRef}
      >
        <div className="w-full bg-gray-900 p-2 md:p-4 rounded-lg overflow-hidden h-96">
          <div
          ...
          >
            ...
            >
              ...
              <div className="flex justify-center mb-8">
                <div className="bg-gray-700 py-3 px-16 w-3/5 text-center rounded">
              ...
              {/* Main Back section */}
              <div className="flex justify-center items-end w-full mt-8 gap-2 ">
                {/* Left section */}
